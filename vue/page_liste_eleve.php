<h2> Cherche le note d'un eleve </h2>
    ...
    <h2> Liste des eleves </h2>
        <form method="post">
            Trier par : 
            <select name="trier">
                <option value = "">Select Odre</option>
                    ...
                    if(isset($lesEleves)){
                        foreach($lesEleves as $unEleve){
                            echo "<tr>";
                                ...
                                echo "<td>";
                                    echo "<a href='index.php?page=2&action=edit&id_eleve=".$unEleve['id_eleve']."'> <img src='img/editer.png' height='30' witdh='30'> </a>";
                                    echo "<a href='index.php?page=1&action=sup&id_eleve=".$unEleve['id_eleve']."'> <img src='img/supprimer.png' height='30' witdh='30'> </a>";
                                echo "</td>";
                            echo "</tr>";
                        }
                    }
